                ...
                <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                  <div class="flex-1 overflow-y-auto py-6 px-4 sm:px-6">
                    <div class="flex items-start justify-between">
                      <DialogTitle class="text-lg font-medium text-gray-900">Shopping cart {{ cartItems }} items</DialogTitle>
                          ...
                          <li v-for="cart in carts" :key="cart.id" class="flex py-6">
                            ...
                            <div class="ml-4 flex flex-1 flex-col">
                              ...
                              <div class="flex flex-1 items-end justify-between text-sm">
                                ...
                                <div class="flex">
                                  <button type="button" class="font-medium text-indigo-600 hover:text-indigo-500" @click="removeFromCart(cart.id)">Remove</button>
                                </div>
                              </div>
                            </div>
                          </li>
                  ...
                  <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
                    ...
                    <div class="mt-6">
                      <a href="#" class="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700" @click="placeOrder">Place Order</a>
                    </div>
